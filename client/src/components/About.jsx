      ...
      <div className="grid lg:grid-cols-2 gap-2 items-center">
        <div className="mb-12 lg:mb-0 px-4">
          <div className="block rounded-lg shadow-lg px-6 py-12 md:px-12 lg:-mr-16"
            ...
            <p className="text-gray-600 mb-6 pb-2 lg:pb-0">
            ...
            their goals. <span className='text-[#027E72] underline'>Erotic photography</span> is my passion. I believe that every body is unique and 
        ...
        <div className='px-4'>
          <img 
          src={Rocks} 
          className="rounded-lg shadow-lg shadow-gray-400 hover:opacity-70"
          alt="" />
        </div>
      </div>
    </div>
